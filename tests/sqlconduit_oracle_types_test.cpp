...
int main()
{
    ...
    {
        using sqlconduit::common::oracleSqlState;
        ...
        const auto dup = sqlconduit::common::Status::databaseError(
            sqlconduit::common::ErrorCode::QueryError, "ORA-00001", oracleSqlState(1), 1);
        check(dup.code == sqlconduit::common::ErrorCode::ConstraintViolation,
              "ORA-00001 经 databaseError 归类为 ConstraintViolation");
        const auto dead = sqlconduit::common::Status::databaseError(
            sqlconduit::common::ErrorCode::QueryError, "ORA-00060", oracleSqlState(60), 60);
        check(dead.code == sqlconduit::common::ErrorCode::Deadlock && dead.retryable,
              "ORA-00060 归类为可重试的 Deadlock");
        const auto lost = sqlconduit::common::Status::databaseError(
            sqlconduit::common::ErrorCode::QueryError, "ORA-03113", oracleSqlState(3113), 3113);
